...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/styles/cart.css"></c:url>">
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/styles/cart_responsive.css"></c:url>">